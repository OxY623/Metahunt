...
| POST  | `/api/v1/auth/refresh`  | Обновить access token     | 🍪 Cookie   |
| POST  | `/api/v1/auth/logout`   | Выход и отзыв refresh     | 🍪 Cookie   |
...
| PATCH | `/api/v1/admin/users/{user_id}/role` | Изменить роль пользователя | ✅ Admin    |
