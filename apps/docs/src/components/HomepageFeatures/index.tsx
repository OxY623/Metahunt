...
const FeatureList = [
  ...
  },
  {
    ...
    description: (
      <>
        Экономика на базе <code>Shards</code> объединяет хакеров, торговцев,
        наемников и дилеров. Стань лучшим в касте Bear. Торгуй в кибер-притонах
        и сражайся в секторах Wolf и Owl.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Бэкенд на <code>FastAPI</code> + <code>PostgreSQL</code>, фронтенд на{" "}
        <code>Next.js 16</code> и облачные сервисы. Построено на Turborepo. Мы
        ценим мощь.
      </>
    ),
  },
