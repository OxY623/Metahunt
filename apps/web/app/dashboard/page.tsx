  ...
  return (
    <main className="min-h-screen pb-16">
      ...
      <div className="page-shell pt-10 space-y-6">
        ...
        {profile && (
          <Panel variant="pink" className="space-y-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
              <p>
                <span className="text-text-dim">Архетип:</span>{" "}
                {profile.archetype ?? "—"}
              </p>
              <p>
              ...
              <p>
                <span className="text-text-dim">XP:</span> {profile.xp} /{" "}
                {profile.xp_to_next}
              </p>
              <p>
                <span className="text-text-dim">Репутация:</span>{" "}
                {profile.reputation}
              </p>
              <p>
        ...
        {!profile?.archetype && (
          <ArchetypePicker token={token} onChosen={refresh} />
        )}
        ...
        {actionMsg && (
          <div className="text-xs text-brand-cyan">{actionMsg}</div>
        )}
      </div>
    </main>
  );
